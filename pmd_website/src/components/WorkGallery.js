...
return ( <section className="work-gallery"> <div className="work-gallery-container"> <div className="work-gallery-header"> <span className="work-gallery-eyebrow">Our Recent Work</span>
